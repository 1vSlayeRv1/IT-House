...
class MessageToSupport(models.Model):
    ...
    date = models.DateTimeField(auto_now_add=True, null=False, blank=False, verbose_name='дата создания')
...
class SupportSection(models.Model):
    section = models.CharField(max_length=150, null=False, blank=False, verbose_name='название раздела')
